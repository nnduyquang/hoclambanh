        ...
        <div class="container">
            <div class="row p-0 align-self-center pt-2 pb-2">
                <div class="col-md-8 d-none d-lg-block d-md-block text-left align-self-center" id="fe_layout_topinfo">
                    <ul>
                        <li><p><i class="fas fa-phone-square"></i> +84 0123 456 789</p></li>
                        <li><p><i class="fas fa-clock"></i> Mon - Sat: 7:00 - 17:00</p></li>
                        <li><p><i class="far fa-envelope"></i> info@bakerytheme.com</p></li>
                    </ul>
            ...
            <div class="row">
                <div class="col-md-12 pt-3 pb-3 text-center">
                    <ul>
                        ...
                        <li>
                            <img class="logo"
                                 src="http://preview.milingona.co/themes/bakery/main/wp-content/themes/bakery/assets/img/bakery-logo-dark.png"
                                 alt="">
