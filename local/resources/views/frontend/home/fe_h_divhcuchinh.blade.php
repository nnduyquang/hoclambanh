...
<div class="container-fluid" id="fe_h_dvchinh">
    <div class="container">
        <div class="row">

            <div class="col-md-12 text-center mb-5 mt-5">
                <p>CHƯƠNG TRÌNH HỌC LÀM BÁNH</p>
                <hr>
                <span>Chúng tôi cung cấp những khóa học dạy làm bánh chuyên nghiệp</span>
            </div>


            <div class="col-md-3 col-sm-6 col-12 mb-4 text-center">
                <div class="card one-product h-100 rounded">
                    ...
                    {{--<div class="info card-footer bg-transparent border-0 text-center pt-2 pb-3">--}}
                        {{--<span style="font-size: 12px;color: #1b1e21;">Read More</span>--}}
                    {{--</div>--}}
                </div>
            </div>
            ...
            <div class="col-md-3 col-sm-6 col-12 justify-content-center mb-4">
                <div class="card one-product h-100 rounded">
                    <a href="#">
                        <div class="img-detail">
